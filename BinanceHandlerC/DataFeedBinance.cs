...
namespace BinanceHander
{
    ...
    public class DataFeedBinance:DataFeedBase
    {
        ...
        public override void SubMarketData(SymbolInfo info, string exchange, string symbol)
        {
            ...
            {
                //trade stream
                socketClient.CoinFuturesStreams.SubscribeToAggregatedTradeUpdatesAsync(symbol, HandleEvent);
                //quote stream best ask/bid
                socketClient.CoinFuturesStreams.SubscribeToBookTickerUpdatesAsync(symbol, HandleEvent);
                //order book
                socketClient.CoinFuturesStreams.SubscribeToPartialOrderBookUpdatesAsync(symbol, 10, 100, HandeEvent);
            }
